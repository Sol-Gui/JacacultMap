...
const Sidebar: React.FC<SidebarProps> = ({ visible, onClose, theme }) => {
  ...
  return (
    <View className="absolute inset-0 z-[1000] bg-black/50">
      ...
      <View className="absolute bottom-0 left-0 top-0 w-[88%] max-w-[360px] shadow-2xl" style={{ backgroundColor: theme.background }}>
        {/* Header do Sidebar */}
        <View className="border-b px-5 pb-5 pt-6" style={{ borderBottomColor: theme.border }}>
        ...
        <ScrollView className="flex-1 px-4 py-4">
          {menuItems
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-sm font-medium" style={{ color: theme.text }}>
                {item.title}
              </Text>
        ...
        {/* Footer do Sidebar */}
        <View className="border-t p-4" style={{ borderTopColor: theme.border }}>
          <TouchableOpacity
          ...
          >
            ...
            <Text className="ml-2 text-sm font-semibold" style={{ color: '#ff4757' }}>
              Sair da Conta
            </Text>
          </TouchableOpacity>
        </View>
